# Aproveitamento Futebol Amazonas, Pará e Nordeste em jogos oficiais no ano de 2024

# Objetivo:
# - Criar script para automatizar aproveitamento dos times do Amazonas Pará e Nordeste, mês a mês
...
aproveitamento_times_am_pa_ne_geral_2024 <- times_am_pa_ne_geral_2024 %>%
...
jogos_disputados_am_pa_ne_2024 <- times_am_pa_ne_geral_2024 %>%
...
jogos_disputados_am_pa_ne_2024

view(jogos_disputados_am_pa_ne_2024)
