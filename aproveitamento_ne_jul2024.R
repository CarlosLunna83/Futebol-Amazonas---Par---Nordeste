# Aproveitamento das equipes da Amazonas - Pará - Nordeste no mês de Julho de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_am_pa_ne_jul2024 <- times_am_pa_ne_geral_2024 %>%
...
aproveitamento_times_am_pa_ne_jul2024
...
aproveitamento_times_am_pa_ne_jul2024$time <- factor(aproveitamento_times_am_pa_ne_jul2024$time, 
                                                        levels = unique(aproveitamento_times_am_pa_ne_jul2024$time))
...
aproveitamento_times_am_pa_ne_jul2024 %>%
  ...
  labs(title = "Aproveitamento times AM PA e NE em Julho 2024",
       x = "Times",
       y = "Aproveitamento")
