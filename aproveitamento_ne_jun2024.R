# Aproveitamento das equipes da Amazonas - Pará - Nordeste no mês de Junho de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_am_pa_ne_jun2024 <- times_am_pa_ne_geral_2024 %>%
...
aproveitamento_times_am_pa_ne_jun2024
...
aproveitamento_times_am_pa_ne_jun2024$time <- factor(aproveitamento_times_am_pa_ne_jun2024$time, 
                                                        levels = unique(aproveitamento_times_am_pa_ne_jun2024$time))
...
aproveitamento_times_am_pa_ne_jun2024 %>%
  ...
  labs(title = "Aproveitamento times AM PA e NE em Junho 2024",
       x = "Times",
       y = "Aproveitamento")

# Jogos disputados por cada equipe em Junho 2024:

jogos_disputados_am_pa_ne_jun2024 <- times_am_pa_ne_geral_2024 %>%
...
jogos_disputados_am_pa_ne_jun2024
