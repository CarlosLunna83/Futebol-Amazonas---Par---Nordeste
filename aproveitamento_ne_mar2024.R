# Aproveitamento das equipes da Amazonas - Pará - Nordeste no mês de Março de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_am_pa_ne_mar2024 <- times_am_pa_ne_geral_2024 %>%
...
aproveitamento_times_am_pa_ne_mar2024$time <- factor(aproveitamento_times_am_pa_ne_mar2024$time, 
                                                        levels = unique(aproveitamento_times_am_pa_ne_mar2024$time))
...
# Jogos disputados por cada equipe em Março 2024:

jogos_disputados_am_pa_ne_mar2024 <- times_am_pa_ne_geral_2024 %>%
...
jogos_disputados_am_pa_ne_mar2024
